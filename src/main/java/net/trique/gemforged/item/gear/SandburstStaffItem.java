...
public class SandburstStaffItem extends Item {
    ...
    private static final float BASE_KNOCKBACK = 14.0f;
    private static final double VERTICAL_BOOST = 1.2;
    ...
    private static final float YELLOW_SCALE = 2.2f;
    private static final float SAND_SCALE = 2.6f;
    ...
    private static final float RINGS_HEIGHT = 2.4f;
    ...
    private void spawnRingWithSpikesColored(ServerLevel level, Vec3 center, float radius,
        ...
        int points = Math.max(18, (int) (radius * 22 * density));
        int layers = 10;
